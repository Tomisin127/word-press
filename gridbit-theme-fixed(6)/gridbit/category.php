...
<?php if ( !(gridbit_get_option('hide_cats_title')) ) { ?>
<div class="gridbit-page-header-outside">
<header class="gridbit-page-header">
<div class="gridbit-page-header-inside">
<?php the_archive_title( '<h1 class="page-title">', '</h1>' ); ?>
<?php if ( !(gridbit_get_option('hide_cats_description')) ) { ?><?php the_archive_description( '<div class="taxonomy-description">', '</div>' ); ?><?php } ?>
</div>
</header>
</div>
<?php } ?>
